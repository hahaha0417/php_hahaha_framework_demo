...
class linebot_broadcast
{
    ...
    */
    public function Text(&$linebot, $message, $notification_disabled = false)
    { 
        $message_text_ = new \LINE\LINEBot\MessageBuilder\TextMessageBuilder($message);
        return $linebot->Linebot_->broadcast($message_text_, $notification_disabled);
    }
    ...
    return LINE\LINEBot\Response
    */
    public function Image(&$linebot, $image, $preview, $notification_disabled = false)
    {
        $message_image_ = new \LINE\LINEBot\MessageBuilder\ImageMessageBuilder($image, $preview);
        return $linebot->Linebot_->broadcast($message_image_, $notification_disabled);
    }	
    ...
    return LINE\LINEBot\Response
    */
    public function Video(&$linebot, $video, $preview, $notification_disabled = false)
    {
        $message_video_ = new \LINE\LINEBot\MessageBuilder\VideoMessageBuilder($video, $preview);
        return $linebot->Linebot_->broadcast($message_video_, $notification_disabled);
    }	
    ...
    return LINE\LINEBot\Response
    */
    public function Audio(&$linebot, $audio, $duration, $notification_disabled = false)
    {
        $message_audio_ = new \LINE\LINEBot\MessageBuilder\AudioMessageBuilder($audio, $duration);
        return $linebot->Linebot_->broadcast($message_audio_, $notification_disabled);
    }	
    ...
    return LINE\LINEBot\Response
    */
    public function Location(&$linebot, $title, $address, $latitude, $longitude, $notification_disabled = false)
    {
        $message_location_ = new \LINE\LINEBot\MessageBuilder\LocationMessageBuilder($title, $address, $latitude, $longitude);
        return $linebot->Linebot_->broadcast($message_location_, $notification_disabled);
    }	
    ...
    return LINE\LINEBot\Response
    */
    public function Sticker(&$linebot, $package_id, $sticker_id, $notification_disabled = false)
    {
        $message_sticker_ = new \LINE\LINEBot\MessageBuilder\StickerMessageBuilder($package_id, $sticker_id);
        return $linebot->Linebot_->broadcast($message_sticker_, $notification_disabled);
    }	
    ...
    /
    */
    public function Raw(&$linebot, $message, $notification_disabled = false)
    {
        $message_raw_ = new \LINE\LINEBot\MessageBuilder\RawMessageBuilder($message);
        return $linebot->Linebot_->broadcast($message_raw_, $notification_disabled);
    }	


    public function Multiple(&$linebot, $messages, $notification_disabled = false)
    {
        ...
        return $linebot->Linebot_->broadcast($message_multiple_, $notification_disabled);
    }	
}