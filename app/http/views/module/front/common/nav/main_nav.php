...
*/
class common_nav_main_nav_view extends \hahaha\hahaha_view_base
{
...
// --------------------------------------------------------------------------
?>
<link rel="stylesheet" href="/assets/plugin/Embarcadero/megamenu.css">
<script src="/assets/plugin/Embarcadero/megamenu.js"></script>
<script src="/assets/module/front/common/nav/main_nav/main_nav.js"></script>
<link rel="stylesheet" href="/assets/module/front/common/nav/main_nav/main_nav.css">
<? // -------------------------------------------------------------------------- ?>
    ...
    <div class="container">        
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">                 
            ...
            <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark mr-auto">
                <? foreach($menu_->nav_list as $key => &$value) : ?>   
                    <? if($value['name'] == 'title') : ?>                              
            ...
            <? if(!empty(\ha\Session::Get()->user)) : ?>   
                <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark ml-1" id="">
                    <div class="header_user_name"><a class="nav-link"><?= \ha\Session::Get()->user ?> 您好</a></div>  
                </div>  
                <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark ml-1" id="">
                                ...
                                <? if(!empty(\ha\Session::Get()->user)) : ?> 
                                    <? if(!($value['name'] == 'login')) : ?> 
                                        <? if($value['name'] == 'member') : ?> 
                                            <? if($value['url'] != null) : ?> 
                                                <li class="nav-item"><a class="nav-link" href="<?= $value['url'] ?>"><?= \ha\Session::Get()->user ?> 您好</a></li>
                                            <? elseif($value['url'] == null) : ?> 
                                                <li class="nav-item"><a class="nav-link" ><?= \ha\Session::Get()->user ?> 您好</a></li>
                                            <? endif; ?>
                                        <? else : ?> 
                                            <? if($value['url'] != null) : ?> 
            ...
            */
            ...
            <? if(!empty(\ha\Session::Get()->user)) : ?> 
                <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark mr-1">
                    <div class="header_user_sub_name"><a class="nav-link"><?= \ha\Session::Get()->user ?> 您好</a></div>  
                </div>
                <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark mr-1">
            ...
            <div class="header_sub .nov collapse navbar-collapse bg-dark" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto" style="margin:5px 5px">
                    ...
                    <? foreach($menu_->nav_list['item_sub_content']['menu'] as $key => &$value) : ?>   
                        <? if($value['visible'] == "true") : ?> 
                            ...
                            <? elseif($value['type'] == 'collection_list') : ?> 
                                ...
                                <li class="nav-item dropdown <?= $value['enabled'] ?> " style="z-index:100;">
                                    <? if($value['url'] != null) : ?> 
                                        <a class="nav-link dropdown-toggle popupmenu" href="<?= \ha::url($value['url']) ?>" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $value['title'] ?></a>
                                    <? else : ?> 
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <? foreach($value['menu'] as $key1 => &$value1) : ?> 
                                            <? if($value['url'] != null) : ?> 
                                                <a class="dropdown-item" href="<?= \ha::url($value['url']) ?>"><?= $value1['title'] ?></a>
                                            <? else : ?> 
                            ...
                            <? elseif($value['type'] == 'item' && $value['url'] != null) : ?> 
                                <li class="nav-item header_bar_<?= $value['name'] ?> btn-dark <?= $value['enabled'] ?>" style="z-index:100;">
                                    <a class="nav-link" href="<?= \ha::url($value['url']) ?>"><?= $value['title'] ?></a>
                                </li> 
                            <? elseif($value['type'] == 'item' && $value['url'] == null) : ?> 
                                <li class="nav-item header_bar_<?= $value['name'] ?> btn-dark <?= $value['enabled'] ?> " style="z-index:100;">
                                        ...
                                        <ul class="container">
                                            <? foreach($value['menu'] as $key1 => &$value1) : ?> 
                                                ...
                                                <? elseif($value1['item'] == 'category_item') : ?> 
                                                    <li class="parentitem">
                                                        <? if(!empty($value1['url']) && $value1['url'] != null) : ?> 
                                                            <a href="<?= \ha::url($value1['url'])?>"><?= $value1['title'] ?>
                                                        <? else : ?> 
                                                            <a><?= $value1['title'] ?>
                                                        <? endif; ?>
                                                            <sup>
